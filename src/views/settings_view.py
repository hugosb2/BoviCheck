...
def build_general_settings_view(controller) -> ft.ListView:
    return ft.ListView(controls=[
            ft.ListTile(leading=ft.Icon(ft.Icons.SETTINGS_SUGGEST_OUTLINED), title=ft.Text("Configurações de IA"), subtitle=ft.Text("Habilitar IA e sugestões."), on_click=lambda _: controller.page.go("/ai/settings"), trailing=ft.Icon(ft.Icons.ARROW_FORWARD_IOS_ROUNDED)),
            ft.ListTile(leading=ft.Icon(ft.Icons.BRIGHTNESS_6_OUTLINED), title=ft.Text("Modo de Tema"), subtitle=ft.Text("Claro, escuro ou padrão do sistema."), on_click=lambda _: controller.page.go("/settings/theme_mode"), trailing=ft.Icon(ft.Icons.ARROW_FORWARD_IOS_ROUNDED)),
            ft.ListTile(leading=ft.Icon(ft.Icons.PALETTE_OUTLINED), title=ft.Text("Cor do Tema"), subtitle=ft.Text("Personalize a cor primária do aplicativo."), on_click=lambda _: controller.page.go("/settings/theme_color"), trailing=ft.Icon(ft.Icons.ARROW_FORWARD_IOS_ROUNDED)),
            
            ft.Divider(height=10),
            ft.ListTile(
                leading=ft.Icon(ft.Icons.UPLOAD_FILE_OUTLINED),
            ...
            ft.ListTile(
                leading=ft.Icon(ft.Icons.DOWNLOAD_FOR_OFFLINE_OUTLINED),
